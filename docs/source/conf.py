...
# word_classificator documentation build
...
from word_classificator import __version__ as release

# -- Project information -----------------------------------------------------

project = "word_classificator"
author = "Kedro"
...
htmlhelp_basename = "word_classificatordoc"
...
latex_documents = [
    (
        master_doc,
        "word_classificator.tex",
        "word_classificator Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "word_classificator",
        "Project word_classificator codebase.",
        "Data-Science",
    )
]
